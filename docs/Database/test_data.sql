...
VALUES 
('Dell XPS 13', 1, 'Intel i7, 16GB RAM, 512GB SSD', 'Kho A'),
('MacBook Pro', 1, 'Apple M1, 16GB RAM, 512GB SSD', 'Kho B'),
('Lenovo ThinkPad', 1, 'Intel i5, 8GB RAM, 256GB SSD', 'Kho C');

Select * from device_model where category_id = 1;
Select * from device_model where model_id = 1

INSERT INTO instance_status (name)
VALUES 
(N'Có sẵn'),
(N'Đã mượn'),
(N'Đã hỏng'),
