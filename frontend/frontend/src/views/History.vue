  ...
  <section class="history">
    <header class="page-header">
      ...
      <div class="filters">
        ...
        <button @click="clear">Xóa lịch sử</button>
      </div>
    </header>
    <table class="table">
      <thead>
        <tr><th>Thời gian</th><th>Loại</th><th>Thiết bị</th><th>Người mượn</th></tr>
      </thead>
      <tbody>
        ...
        <tr v-if="filtered.length === 0"><td colspan="4" style="text-align:center">Không có dữ liệu</td></tr>
      </tbody>
    </table>
  </section>
</template>
...
<style scoped>
.history { padding: 16px 12px; }
.page-header { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 12px; }
.filters { display: flex; gap: 8px; }
.filters input, .filters select { padding: 6px 8px; border: 1px solid #e5e7eb; border-radius: 8px; }
