<template>
  <form class="form" @submit.prevent="onSubmit">
    ...
    <div class="form-group">
      ...
      <input v-model="model.deviceName" placeholder="Nhập tên thiết bị" required />
    </div>
    ...
    <div class="form-group">
      ...
      <input v-model="model.storageLocation" placeholder="Nhập vị trí lưu trữ" required />
    </div>
...
function onSubmit() {
  error.value = ''
  if (!model.deviceName) {
    error.value = 'Vui lòng nhập tên thiết bị'
    return
  }
  emit('submit', { ...model })
}
